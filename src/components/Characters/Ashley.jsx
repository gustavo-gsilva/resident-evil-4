...
function Ashley() {
   const { name, phrase, description, images, phrase2, description2 } = characters[3];
   ...
   return (
      <>
         <section
            ...
            items-center 
            gap-40 
            bg-[linear-gradient(to_bottom,_#81623a,_#4A3A27)] 
            py-50"
         >
            <div
               className="grid lg:grid-cols-2 gap-15"
            >

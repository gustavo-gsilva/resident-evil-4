...
function Salazar() {
   const { name, phrase, description, images, phrase2, description2 } = characters[6];
   ...
   return (
      <>
         <section
            ...
            items-center 
            gap-40 
            bg-[linear-gradient(to_bottom,_#58181F,_#5b2329)] 
            py-50"
         >
            ...
            <div className="grid lg:grid-cols-2 gap-15">
               ...
               <div className="flex justify-center pt-10 lg:pr-30">
                  <div>
                     <div className="flex justify-center">
                        <h3
                           className="

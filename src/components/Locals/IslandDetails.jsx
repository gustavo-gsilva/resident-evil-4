...
function IslandDetails() {
   const { name, phrase2, description, islandImages } = locations[2];
         ...
         >
            ...
            <div className="flex gap-8">
               <div className="flex flex-col gap-8">
                  <div
                     ...
                     cursor-zoom-in
                     ml-96"
                     onClick={() => handleOpen(islandImages[1])}
                  >
                     <img
                        className="
                        w-[800px] 
                        h-full 
                        object-cover 
                        group-hover:border-8 border-[#506044] duration-300 ease-in"
                        src={islandImages[1]}
                        alt="Castle Image 2"
                     />
                  ...
                  <div
                     ...
                     group 
                     cursor-zoom-in"
                     onClick={() => handleOpen(islandImages[2])}
                  >
                     <img
                        className="
                        w-[800px] 
               ...
               <div className="flex items-center">
                  <div
                     ...
                     group 
                     cursor-zoom-in"
                     onClick={() => handleOpen(islandImages[3])}
                  >
                     <img
                        className="
                        w-full
            ...
            <div className="flex items-center gap-30">
               <div
                  ...
                  group 
                  cursor-zoom-in"
                  onClick={() => handleOpen(islandImages[4])}
               >
                  <img
                     className="
                     w-full
               ...
               <div className="flex items-center">
                  <div
                     ...
                     group 
                     cursor-zoom-in"
                     onClick={() => handleOpen(islandImages[5])}
                  >
                     <img
                        className="
                        w-full
